export const galleryLightboxStyles = {
  ...
  image:
    "block h-auto max-h-[65vh] w-auto max-w-[90%] object-contain select-none", 
  ...
  counter:
    "absolute bottom-2 left-1/2 -translate-x-1/2 rounded-full bg-black/80 px-4 py-2 text-sm font-semibold text-white",
  ...
  viewer:
"relative flex h-[68vh] items-center justify-center overflow-hidden bg-black",
